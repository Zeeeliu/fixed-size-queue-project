...
class FixedSizeQueue:
    ...
    # if we do not have self.size, we could have a method to find out the size by counting the empty spaces
    # def find_size(self):
    #     return self.max_size - self.queue.count(None)
